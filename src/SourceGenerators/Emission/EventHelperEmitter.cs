...
public static class EventHelperEmitter
{
    public static string Emit(MachineDeclaration declaration, string indent)
    {
        ...
        var runtimeType = "global::StateMachineLibrary.Core.Execution.StateMachineRuntime<" + declaration.StateTypeName + ", " + declaration.EventTypeName + ">";
        var outcomeType = "global::System.Threading.Tasks.ValueTask<global::StateMachineLibrary.Core.Execution.TransitionOutcome<" + declaration.StateTypeName + ", " + declaration.EventTypeName + ">>";
