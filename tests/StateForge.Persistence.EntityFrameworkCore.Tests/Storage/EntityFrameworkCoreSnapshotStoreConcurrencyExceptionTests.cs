...
public sealed class EntityFrameworkCoreSnapshotStoreConcurrencyExceptionTests
{
    [Fact]
    public async Task SaveAsync_ReturnsConflict_WhenExpectedVersionIsNotNumeric()
    {
        ...
        var result = await sut.SaveAsync(PersistenceVersion.From("abc"), proposed);
