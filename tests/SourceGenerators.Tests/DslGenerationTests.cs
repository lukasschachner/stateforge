...
public sealed class DslGenerationTests
{
    ...
    public void ExistingFlatDslDeclarationsKeepGeneratedDefinitionMembers()
    {
        ...
        GeneratorTestHost.AssertCompiles(result);
        Assert.Contains("public static global::StateMachineLibrary.Core.Definitions.StateMachineDefinition<global::OrderState, global::OrderEvent> Definition", result.GeneratedSource);
        Assert.Contains("public static global::StateMachineLibrary.Core.Definitions.StateMachineDefinition<global::OrderState, global::OrderEvent> CreateDefinition()", result.GeneratedSource);
