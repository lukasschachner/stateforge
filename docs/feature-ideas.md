...
This document captures candidate feature ideas for StateForge and groups them into manageable SpecKit feature bundles. Each prompt is intended to be used as a separate `/speckit.specify` invocation.
